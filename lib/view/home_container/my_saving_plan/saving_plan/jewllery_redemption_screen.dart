...
class JewelleryRedemptionScreen extends StatefulWidget {
  final String? planId;
  final String? planType;
  
  const JewelleryRedemptionScreen({
    this.planId,
    this.planType,
    super.key,
  });
  ...
  @override
  State<JewelleryRedemptionScreen> createState() =>
      _JewelleryRedemptionScreenState();
}

class _JewelleryRedemptionScreenState extends State<JewelleryRedemptionScreen> {
  ...
  Future<void> _checkExistingRedemptionStatus() async {
    if (widget.planId == null || widget.planType == null) {
...
class _RedeemInstructionScreenState extends State<RedeemInstructionScreen> {
  ...
  Future<void> _onRedeemPressed() async {
    if (widget.planId == null || widget.planType == null || widget.store.id == null) {
